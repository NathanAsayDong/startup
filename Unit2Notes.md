...
# SOP and CORS
- SOP = Same Origin Policy (to provide security)
...
# PM2
- Daemon --> allows a program to run even when the console closes or the computer restarts
- PM2 is already installed on your production server as part of AWS AMI and it is a daemon
- check if daemon is running if you ssh into server and run "pm2 ls"
### HOW TO REGISTER A NEW WEB SERVICE:
1. Add the rule to the caddyfile to tell it how to direct requests for this domain
2. Create a directory and add the files for the webservice
3. configure pm2
